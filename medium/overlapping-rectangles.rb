...
following format: ["(0,0),(2,2),(2,0),(0,2),(1,0),(1,2),(6,0),(6,2)"] 
...
The coordinates will all be integers. If there's no overlap between the two 
rectangles return 0. 
=end
...
# OverlappingRectangles(STDIN.gets)  
